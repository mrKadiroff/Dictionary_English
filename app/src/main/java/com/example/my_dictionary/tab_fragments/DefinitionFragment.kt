...
import com.example.my_dictionary.adapters.DefinitionAdapter
import com.example.my_dictionary.databinding.FragmentDefinitionBinding
...
class DefinitionFragment : Fragment() {
    ...
    lateinit var binding: FragmentDefinitionBinding
    lateinit var appDatabase: AppDatabase
    lateinit var definitionAdapter: DefinitionAdapter
    lateinit var userViewModel: UserViewModel
    private val TAG = "DefinitionFragment"
...
//                            binding.trans.text = myWord!!.phonetics!![0].text
                            ...
                            definitionAdapter = DefinitionAdapter(myWord!!.meanings[0].definitions)
                            binding.rvAll.adapter = definitionAdapter
